...
namespace Org.OpenAPITools.Model
{
    ...
    /// </summary>
    [DataContract(Name = "UserSettingsOptions")]
    public partial class UserSettingsOptions : IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="UserSettingsOptions" /> class.
        /// </summary>
        ...
        public UserSettingsOptions(string description = default(string), string diffViewStyle = default(string), string fullName = default(string), bool hideActivity = default(bool), bool hideEmail = default(bool), string language = default(string), string location = default(string), string theme = default(string), string website = default(string))
        {
