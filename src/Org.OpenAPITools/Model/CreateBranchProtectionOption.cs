...
namespace Org.OpenAPITools.Model
{
    ...
    /// </summary>
    [DataContract(Name = "CreateBranchProtectionOption")]
    public partial class CreateBranchProtectionOption : IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="CreateBranchProtectionOption" /> class.
        /// </summary>
        ...
        public CreateBranchProtectionOption(List<string> approvalsWhitelistTeams = default(List<string>), List<string> approvalsWhitelistUsername = default(List<string>), bool blockOnOfficialReviewRequests = default(bool), bool blockOnOutdatedBranch = default(bool), bool blockOnRejectedReviews = default(bool), string branchName = default(string), bool dismissStaleApprovals = default(bool), bool enableApprovalsWhitelist = default(bool), bool enableMergeWhitelist = default(bool), bool enablePush = default(bool), bool enablePushWhitelist = default(bool), bool enableStatusCheck = default(bool), bool ignoreStaleApprovals = default(bool), List<string> mergeWhitelistTeams = default(List<string>), List<string> mergeWhitelistUsernames = default(List<string>), string protectedFilePatterns = default(string), bool pushWhitelistDeployKeys = default(bool), List<string> pushWhitelistTeams = default(List<string>), List<string> pushWhitelistUsernames = default(List<string>), bool requireSignedCommits = default(bool), long requiredApprovals = default(long), string ruleName = default(string), List<string> statusCheckContexts = default(List<string>), string unprotectedFilePatterns = default(string))
        {
