...
namespace Gitea.Net.Model
{
    ...
    /// </summary>
    [DataContract(Name = "BranchProtection")]
    public partial class BranchProtection : IValidatableObject
    {
        /// <summary>
        ...
        /// <param name="branchName">Deprecated: true.</param>
        ...
        public BranchProtection(List<string> approvalsWhitelistTeams = default(List<string>), List<string> approvalsWhitelistUsername = default(List<string>), bool blockOnOfficialReviewRequests = default(bool), bool blockOnOutdatedBranch = default(bool), bool blockOnRejectedReviews = default(bool), string branchName = default(string), DateTime createdAt = default(DateTime), bool dismissStaleApprovals = default(bool), bool enableApprovalsWhitelist = default(bool), bool enableMergeWhitelist = default(bool), bool enablePush = default(bool), bool enablePushWhitelist = default(bool), bool enableStatusCheck = default(bool), bool ignoreStaleApprovals = default(bool), List<string> mergeWhitelistTeams = default(List<string>), List<string> mergeWhitelistUsernames = default(List<string>), string protectedFilePatterns = default(string), bool pushWhitelistDeployKeys = default(bool), List<string> pushWhitelistTeams = default(List<string>), List<string> pushWhitelistUsernames = default(List<string>), bool requireSignedCommits = default(bool), long requiredApprovals = default(long), string ruleName = default(string), List<string> statusCheckContexts = default(List<string>), string unprotectedFilePatterns = default(string), DateTime updatedAt = default(DateTime))
        {
