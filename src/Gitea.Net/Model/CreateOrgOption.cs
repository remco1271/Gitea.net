...
namespace Gitea.Net.Model
{
    ...
    /// </summary>
    [DataContract(Name = "CreateOrgOption")]
    public partial class CreateOrgOption : IValidatableObject
    {
        /// <summary>
        ...
        public CreateOrgOption(string description = default(string), string email = default(string), string fullName = default(string), string location = default(string), bool repoAdminChangeTeamAccess = default(bool), string username = default(string), VisibilityEnum? visibility = default(VisibilityEnum?), string website = default(string))
        {
            // to ensure "username" is required (not null)
            if (username == null)
            {
                throw new ArgumentNullException("username is a required property for CreateOrgOption and cannot be null");
            }
