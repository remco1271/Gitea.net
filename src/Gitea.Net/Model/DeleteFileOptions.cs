...
namespace Gitea.Net.Model
{
    ...
    /// </summary>
    [DataContract(Name = "DeleteFileOptions")]
    public partial class DeleteFileOptions : IValidatableObject
    {
        /// <summary>
        ...
        public DeleteFileOptions(Identity author = default(Identity), string branch = default(string), Identity committer = default(Identity), CommitDateOptions dates = default(CommitDateOptions), string message = default(string), string newBranch = default(string), string sha = default(string), bool signoff = default(bool))
        {
            // to ensure "sha" is required (not null)
            if (sha == null)
            {
                throw new ArgumentNullException("sha is a required property for DeleteFileOptions and cannot be null");
            }
            this.Sha = sha;
            this.Author = author;
            this.Branch = branch;
